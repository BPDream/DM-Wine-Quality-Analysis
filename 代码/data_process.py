...
# 原始数据
data = pd.read_csv('C:/Polybasic Disk/Python_Project1/data/winequalityN.csv')
data.columns = ['type', 'fixed acidity', 'volatile acidity', 'citric acid', 'residual sugar',
                'chlorides', 'free sulfur dioxide', 'total sulfur dioxide', 'density', 'pH',
                'sulphates', 'alcohol', 'quality']

# 去重后的红葡萄酒、白葡萄酒数据
data1 = pd.read_csv('C:/Polybasic Disk/Python_Project1/data/red.csv')
data2 = pd.read_csv('C:/Polybasic Disk/Python_Project1/data/white.csv')
...
#         tmp.append(data1[col].mean())  # 均值
#         tmp.append(data1[col].std())  # 标准差
#         tmp.append(data1[col].min())  # 最小值
#         tmp.append(data1[col].max())  # 最大值
#         y.append(tmp)
#
...
#
# data1.to_csv(path_or_buf="C:/Polybasic Disk/Python_Project1/data/redwineNew.csv")
# data2.to_csv(path_or_buf="C:/Polybasic Disk/Python_Project1/data/whitewineNew.csv")
#
...
# 红酒数据
# val_data是数据量*原维度的矩阵
val_data = pd.read_csv("C:/Polybasic Disk/Python_Project1/data/redwineNew.csv")
# 除去“属性”字段
...
# pd.DataFrame(new_data).to_csv("C:/Polybasic Disk/Python_Project1/data/redwinePCA.csv",index=0,header=['PC1','PC2'])

# 白酒数据
# val_data是数据量*原维度的矩阵
val_data = pd.read_csv("C:/Polybasic Disk/Python_Project1/data/whitewineNew.csv")
# 除去”属性“字段
val_data = val_data.drop(columns='type')
# 除去“质量”字段
val_data = val_data.drop(columns='quality')
...
# pd.DataFrame(new_data).to_csv("C:/Polybasic Disk/Python_Project1/data/whitewinePCA.csv",index=0,header=['PC1','PC2'])
