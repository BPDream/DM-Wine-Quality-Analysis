...
# 分类：红葡萄酒 白葡萄酒
data1 = pd.read_csv('C:/Polybasic Disk/Python_Project1/data/red_wine_original.csv')
data2 = pd.read_csv('C:/Polybasic Disk/Python_Project1/data/white_wine_original.csv')
